...
import { TEMPLATE_CATEGORIES, type TemplatePreset, type TemplateCategory } from "@/lib/templates/presets";
    ...
    (set) => ({
      ...
      duplicate: (source, name) => {
        ...
        const preset: TemplatePreset = {
          ...
          category: (TEMPLATE_CATEGORIES.includes(source.category) ? source.category : "Modern Worship") as TemplateCategory,
        };
        set((s) => ({ templates: [preset, ...s.templates] }));
        return preset;
      },
